...
class StereoWindow:
    ...
    def __init__(
        ...
        self.vsync = local_vsync
        self.upscaler = upscaler
        self.upscaler_sharpness = upscaler_sharpness
    ...
    def update_runtime_frame(self, runtime_result, current_fps=None, current_latency=None):
        ...
        rgb_np = _as_numpy_rgb(runtime_result.sbs)
        depth_np = np.ascontiguousarray(_as_numpy_depth(runtime_result.depth).astype(np.float32, copy=False))
        h, w = rgb_np.shape[:2]
